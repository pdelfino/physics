...
float y_speed = 0; //depois meter o random aqui
...
void draw() {
  ...
  println("altura pazinha ",j, "final da pazinha", j+17); //"posicao bola",y_bola_pos);
  //x_bola>605 && x_bola<610
  //if (y_bola <j+8 && y_bola >j-8  ) {
  //  x_speed *= -1;
  //}
